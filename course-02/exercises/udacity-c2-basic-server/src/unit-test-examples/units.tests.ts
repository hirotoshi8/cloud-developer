...
describe('concat', () => {
  ...
  it('should concatenate "Aichi" and "kariya" ', () => {
    const result = concat("Aichi ","kariya ");
    expect(result).to.equal("Aichi kariya ");
  });

  it('should concatenate "Aishin " and  "Seiki" ', () => {
    const result = concat("Aisin ","Seiki ");
    expect(result).to.equal("Aisin Seiki ");
  });
